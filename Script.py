...
<blockquote>ɪᴍ ᴍᴏsᴛ ᴘᴏᴡᴇʀꜰᴜʟ & ᴀᴅᴠᴀɴᴄᴇ ᴀɪ ᴘᴏᴡᴇʀᴅ 🤖 ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ..
...
» sᴛᴇᴘ 2:- ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ <a href=https://zipshort.net/ref/Zipshort>zipshort.net</a> [ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴏᴛʜᴇʀ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ]
...
©️ Powered by: <b>{message.chat.title}</b>"""
    ...
    FILE_CAPTION = """<b>➤ Nᴀᴍᴇ:<a href=https://t.me/+bEarHRzuylxjMTk1>{file_name}</a>

<blockquote> ᴘʟᴇᴀsᴇ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ᴄʟᴏsᴇ ʙᴜᴛᴛᴏɴ ɪꜰ ʏᴏᴜ ʜᴀᴠᴇ sᴇᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ..✨</blockquote></b>"""
...
- ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ᴀɴ Pʀɪᴠᴀᴛᴇ ᴘʀᴏᴊᴇᴄᴛ.

- ꜱᴏᴜʀᴄᴇ - <a href=https://t.me/+hqgL_Dok0Us3ODM1> ᴄʟɪᴄᴋ ʜᴇʀᴇ </a>
